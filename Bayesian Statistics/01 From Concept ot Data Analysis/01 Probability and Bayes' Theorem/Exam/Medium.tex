...
% Redefine how section titles are written into the marks:
% use "1 Artificial Intelligence in Algorithmic Trading" exactly as written,
% without automatic uppercasing.
\renewcommand{\sectionmark}[1]{%
  \markboth{\thesection\ #1}{}%
}

% Left header: current section name in small caps, without extra uppercasing
